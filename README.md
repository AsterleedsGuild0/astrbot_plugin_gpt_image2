...
`v0.3.0-test.YYYYMMDD.HHMM` 形式的真实测试版本号，但不会修改工作区文件。
如需正式包，可选择 `Package AstrBot plugin (release)`。

默认输出：

```text
dist/astrbot_plugin_gpt_image2_233-v0.3.0.zip
```
...
```text
dist/astrbot_plugin_gpt_image2_233-v0.3.0-test.20260517.1548.zip
```
